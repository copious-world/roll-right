...
class Phase2 {
    ...
    config(tconf,target) {
        ...
        //
        where_is_subst_file = where_is_subst_file.replace('$$target',target)
        ...
        where_are_scripts = translate_marker(where_are_scripts,tconf) + '/tools'
            ...
            console.log("----------------")
            console.log(where_is_subst_file)
            console.log(where_is_template_file)
            console.log(where_does_output_go)
            console.log(where_are_scripts)
