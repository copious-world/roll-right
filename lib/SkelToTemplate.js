...
console.dir(exec_report)
     ...
     * @returns {string}
     */
    coalesce_array(p_def) {
        let loop_el_var = p_def.element_generator.var_name
        console.log("coalesce_array",loop_el_var)
        ...
        if ( dform.length ) {
            ...
            let beg_mark = dform.indexOf(b_marker_str)
            beg_mark += b_marker_str.length
            let end_marker = dform.indexOf(`</@${loop_el_var}>`)
            dform = dform.substring(beg_mark,end_marker)
            //
...
// console.trace()
// }
                    if ( p_def.element_generator?.is_range ) {              // RANGE <start,end>
                        ...
                        will_return_data = this.coalesce_array(p_def)
                    } else {
