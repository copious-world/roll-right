    ...
    */
    ...
    async section_parsing(all_skeletons) {
        ...
        for ( let [ky,data] of Object.entries(all_skeletons) ) {
            ...
            // for testing
            //
            if ( defaults ) { // at this point this means tphe array has any elements
                defaults = defaults.trim()
                if ( defaults.indexOf("defs:") === 0 ) {  // if present, this becomes a structure.
     ...
     */
    bundle_based_transformations(transform_1) {
        //
...
//console.log("list_to_skeletal_variable_assignment",entry.recursive.params_def)
    ...
    async skeleton_parsing(all_skeletons) {
        ...
        //
        await this.bundle_based_transformations(transform_1)
...
//         await this.prep_script_directories(occurence_partition)
    ...
    async generate_all_concerns_templates(parsed_skels) {
        ...
        await this.write_templates(concerns)
        return concerns
    }
...
console.log("write_templates",dir_form,">>",t_path)
