...
console.log("leaf_html_directives -- before",op)
console.dir(skel_def)
                let sk_map = {}
...
console.log("leaf_html_directives -- after",op)
console.dir(skel_def)
            }
        }
    }
...
console.log("finalize_markup")
console.dir(transformed, { depth : 6 })
        for ( let [sk_name, op_map ] of Object.entries(transformed) ) {
            for ( let [op, skel ] of Object.entries(op_map) ) {
                let sk_map = skel.skeleton_map
                if ( typeof sk_map !== "object" ) continue
...
console.log("finalize_markup",sk_name,op)
console.dir(sk_map)
//
                for ( let [entry_ky,desciptor] of Object.entries(sk_map) ) {
...
console.log("skel_compiled_path==============================================",skel_compiled_path)
